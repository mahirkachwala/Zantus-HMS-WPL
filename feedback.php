...
if (isset($_POST['submit'])) {
	...
	if ($nameIn === '' || $emailIn === '' || $textIn === '') {
		...
		$ins = hms_query($con, "INSERT INTO feedback_entries(portal_type,user_id,doctor_id,name,email,rating,feedback_text,status,created_at) VALUES('user','".(int)$userId."',NULL,'$nameIn','$emailIn',$ratingSql,'$textIn','New',NOW())");
		if ($ins) {
...
<body class="nav-md">
<?php $page_title = 'User | Feedback'; $x_content = true; include('include/header.php');?>
<div class="row">
