...
$_SESSION['msg'] = 'Queries module has been removed.';
...
if(isset($_POST['update']))
{
	...
	$isread=1;
	$query=hms_query($con,"update tblcontactus set  AdminRemark='$adminremark',IsRead='$isread' where id='$qid'");
	if($query){
		...
		<div class="col-md-12">
			...
			<table class="table table-hover" id="sample-table-1">
				...
				<tbody>
					<?php
					$qid=intval($_GET['id']);
					$sql=hms_query($con,"select * from tblcontactus where id='$qid'");
					$cnt=1;
